...
class DashboardItem(UUIDAuditBase, table=True):
    """Elemento del grid: una gráfica o un widget de texto.

    position_config: {x, y, w, h} de react-grid-layout.
    local_config: filtros propios del item, o contenido del widget de texto.
    """
    ...
    item_type: str = Field(default="chart", max_length=20)  # chart | text
